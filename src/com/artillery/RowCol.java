...
public class RowCol {
    ...
    public RowCol() {
        ...
        while (true) {
            ...
            unverifiedOutput = BufferedReaderClass
                    .readLine("Where do you want to place this ship? Enter a letter A-J followed by a number 1-10")
                    .toUpperCase();
            ...
            if ('A' <= gridLetter && gridLetter <= 'J') { // converting Row letter to a number
                ...
                System.out.println("Plz enter letter A thru J.");
            ...
            if (1 <= col && col <= 10) {
                ...
                System.out.println("Plz enter number 1 thru 10.");
            }
